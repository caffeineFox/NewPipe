...
public class InfoListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	...
	private List<InfoItem> contentFilterInfoItems(List<? extends InfoItem> infoItems) {
		List<InfoItem> data = new ArrayList<>(infoItems);
		List<ContentFilterFragment.ContentFilterItem> filterItemList = ContentFilterHelper.getEnabledContentFilterItemList(layoutInflater.getContext());
		...
		for (InfoItem item : data) {
			...
			final String finalTextToCheck = textToCheck;
